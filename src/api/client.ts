...
//  Loja é criada com chave publica/privada. A chave privada é armazenada localmente (localStorage). 
//  Chave publica é enviada ao backend para ser associada à loja.
//  O backend irá usar a chave publica para verificar as assinaturas das ofertas criadas por esta loja.
...
//Resgata a chage privada da loja e assina a oferta. O backend irá usar a chave publica associada à loja para verificar esta assinatura.
