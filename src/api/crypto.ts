...
//Criação da chave publica/privada da loja. A chave privada é armazenada localmente (localStorage) e 
// a chave publica é retornada para ser enviada ao backend e associada à loja.
...
// Mensagem assinada/verificada. O backend reconstroi exatamente esta
